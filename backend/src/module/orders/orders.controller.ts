...
export class OrdersController {
  ...
  @Delete(':order_id/:shop_id')
  deleteOrder(
    @Param('order_id') order_id: string,
    @Param('shop_id') shop_id: string,
  ): Promise<void> {
    return this.ordersService.deleteOrder(order_id, shop_id);
  }
  @Patch(':order_id/:shop_id/ready')
  readyOrder(
    @Param('order_id') order_id: string,
    @Param('shop_id') shop_id: string,
  ): Promise<void> {
    return this.ordersService.readyOrder(order_id, shop_id);
  }
  @Patch(':order_id/:shop_id/received')
  receivedOrder(
    @Param('order_id') order_id: string,
    @Param('shop_id') shop_id: string,
  ): Promise<void> {
    return this.ordersService.receivedOrder(order_id, shop_id);
  }
}